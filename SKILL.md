...
⚠️ **What this skill covers / doesn't cover → load [`references/00_scope/`](./references/00_scope/_index.md)** (full design trade-offs in the GitHub repo's [`docs/SCOPE.md`](https://github.com/RayLi-Git/compass/blob/main/docs/SCOPE.md))

---

## 🗺️ Topic modules (load the matching references/ on demand)

> §0 scope boundary + §1–§11 all modules + §6.6 SLA + §11 executable scripts + EN/ZH bilingual — all delivered. Full design trade-offs and future directions in the GitHub repo's [`docs/SCOPE.md`](https://github.com/RayLi-Git/compass/blob/main/docs/SCOPE.md).
...
- [docs/SCOPE.md](https://github.com/RayLi-Git/compass/blob/main/docs/SCOPE.md) — full scope, design trade-offs and future directions
- [docs/DESIGN.md](https://github.com/RayLi-Git/compass/blob/main/docs/DESIGN.md) — design decisions and trade-offs
- [docs/INSTALL.md](https://github.com/RayLi-Git/compass/blob/main/docs/INSTALL.md) — installation guide
- [README.md](https://github.com/RayLi-Git/compass/blob/main/README.md) — project overview
