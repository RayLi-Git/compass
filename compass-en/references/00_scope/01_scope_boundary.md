...
Full design trade-offs, future directions, and how to contribute: see the GitHub repo's [`docs/SCOPE.md`](https://github.com/RayLi-Git/compass/blob/main/compass-en/docs/SCOPE.md).
