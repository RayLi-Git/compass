...
⚠️ **本 skill 涵蓋什麼 / 不涵蓋什麼 → 載 [`references/00_scope/`](./references/00_scope/_index.md)**（完整設計取捨與未來方向見 GitHub repo 的 [`docs/SCOPE.md`](https://github.com/RayLi-Git/compass/blob/main/compass-zh/docs/SCOPE.md)）

---

## 🗺️ 主題模組（按需載入對應的 references/）

> §0 範圍邊界 + §1–§11 全模組 + §6.6 SLA + §11 可執行腳本 + 中英雙語，皆已交付。完整設計取捨與未來方向見 GitHub repo 的 [`docs/SCOPE.md`](https://github.com/RayLi-Git/compass/blob/main/compass-zh/docs/SCOPE.md)。
...
- [docs/SCOPE.md](https://github.com/RayLi-Git/compass/blob/main/compass-zh/docs/SCOPE.md) — 完整範圍、設計取捨與未來方向
- [docs/DESIGN.md](https://github.com/RayLi-Git/compass/blob/main/compass-zh/docs/DESIGN.md) — 設計決策與取捨
- [docs/INSTALL.md](https://github.com/RayLi-Git/compass/blob/main/compass-zh/docs/INSTALL.md) — 安裝指南
- [README.md](https://github.com/RayLi-Git/compass/blob/main/compass-zh/README.md) · [README.md](https://github.com/RayLi-Git/compass/blob/main/README.md) — 專案總覽（中 / 英）
