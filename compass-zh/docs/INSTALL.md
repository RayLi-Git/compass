...
- 建議搭配工具鏈夥伴一起裝——[Cartographer](https://github.com/RayLi-Git/cartographer) 畫地圖、Compass 照圖走、[Sentinel](https://github.com/RayLi-Git/sentinel) 站哨、[Lookout](https://github.com/RayLi-Git/lookout) 在桅杆瞭望。
...
工具腳本是 §11 規則的可執行範例，範本是 §3.2 追蹤文件的起點。放在**你工作的專案**裡（不是 skills 目錄）。
...
各工具用法見 [`scripts/README.md`](../scripts/README.md) 與 [`templates/README.md`](../templates/README.md)。
...
PRD 要從零生出來見 [Cartographer](https://github.com/RayLi-Git/cartographer)；段落完成後要獨立 context 審查見 [Lookout](https://github.com/RayLi-Git/lookout)。
